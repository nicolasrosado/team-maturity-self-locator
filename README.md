...
- Zooms into a floor axis that has sub-structure: **psychological safety** (Clark's four stages), the **three bounds** (information / cognition / time), **feedback** loops, or **shared mental model** (its cognitive and intent debts).
